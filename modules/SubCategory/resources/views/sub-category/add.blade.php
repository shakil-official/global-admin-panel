...
@section('title', 'SubCategory') <!-- Dynamic page title -->
@section('breadcrumb-main', 'SubCategory Page') <!-- Dynamic page main -->
@section('breadcrumb-title', 'SubCategory') <!-- Dynamic page title -->
