...
@section('title', 'Package') <!-- Dynamic page title -->
@section('breadcrumb-main', 'Package Page') <!-- Dynamic page main -->
@section('breadcrumb-title', 'Package') <!-- Dynamic page title -->
...
@push('scripts')
    ...
    <script>
        document.addEventListener("input", function () {
            let price = parseFloat(document.querySelector('[name="base_price"]').value) || 0;
            let vatPercent = parseFloat(document.querySelector('[name="vat_percentage"]').value) || 0;
            let vatEnabled = document.querySelector('[name="vat_enabled"]').checked;

            let vat = vatEnabled ? (price * vatPercent) / 100 : 0;
            let total = price + vat;
