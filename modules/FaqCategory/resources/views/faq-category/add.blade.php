...
@section('title', 'Faq Category') <!-- Dynamic page title -->
@section('breadcrumb-main', 'Faq Category Page') <!-- Dynamic page main -->
@section('breadcrumb-title', 'Faq Category') <!-- Dynamic page title -->
