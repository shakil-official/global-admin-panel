...
@section('title', 'Paybill') <!-- Dynamic page title -->
@section('breadcrumb-main', 'Paybill Page') <!-- Dynamic page main -->
@section('breadcrumb-title', 'Paybill') <!-- Dynamic page title -->
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const metaFields = document.querySelectorAll('[name^="meta"]');

            function toggleMetaFields() {
                const selected = methodSelect.value;

                metaFields.forEach(input => {
                    const container = input.closest('.form-group, .mb-3'); // adjust based on your FormMaking wrapper
            ...
            toggleMetaFields();
            methodSelect.addEventListener('change', toggleMetaFields);
        });
    </script>
