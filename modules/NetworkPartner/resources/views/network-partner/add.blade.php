...
@section('title', 'Network Partner') <!-- Dynamic page title -->
@section('breadcrumb-main', 'Network Partner Page') <!-- Dynamic page main -->
@section('breadcrumb-title', 'Network Partner') <!-- Dynamic page title -->
