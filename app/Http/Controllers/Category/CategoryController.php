...
class CategoryController extends Controller
{
    ...
    public function add(): Factory|Application|View|\Illuminate\Contracts\Foundation\Application
    {
        ...
        return view('backend.category.add')->with([
            'title' => 'Category Add',
            'buttons' => [
                [
                    'label' => 'Back to List',
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        try {// Find the category to update
    ...
    {
        $data = $this->service->dataTableData()->orderBy('position')->orderBy('updated_at', 'desc'); // Add second orderBy for updated_at
