...
@section('breadcrumb-main', 'Category list')  <!-- Dynamic page main -->
@section('breadcrumb-title', 'Category')  <!-- Dynamic page title -->
@section('breadcrumb-sub-title', 'list')  <!-- Dynamic breadcrumb sub title -->
        ...
        $(document).on('click', '#deleteButton', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('category.delete') }}', // Your Laravel route
                        type: 'delete',
                        data: {
