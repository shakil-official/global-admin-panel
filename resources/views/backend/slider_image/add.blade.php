...
@section('title', 'Brand Image') <!-- Dynamic page title -->
@section('breadcrumb-main', 'Brand Image Page') <!-- Dynamic page main -->
@section('breadcrumb-title', 'Brand Image') <!-- Dynamic page title -->
