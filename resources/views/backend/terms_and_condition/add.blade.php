...
@section('title', 'TermsAndCondition') <!-- Dynamic page title -->
@section('breadcrumb-main', 'TermsAndCondition Page') <!-- Dynamic page main -->
@section('breadcrumb-title', 'TermsAndCondition') <!-- Dynamic page title -->
