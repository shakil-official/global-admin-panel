...
@section('title', 'TermsAndCondition')
@section('breadcrumb-main', 'TermsAndCondition list')
@section('breadcrumb-title', 'TermsAndCondition')
@section('breadcrumb-sub-title', 'list')
    ...
    <script src="{{ asset('theme/assets/js/pages/sweetalerts.init.js') }}"></script>
        ...
        <script>
            ...
            new DataTable("#" + tableId, {
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('TermsAndCondition.list') }}",
            ...
            $(document).on('click', '#deleteButton', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('TermsAndCondition.delete') }}', // Your Laravel route
                            type: 'delete',
                            data: {
