...
<div id="layout-wrapper">
    @include('admin.layouts.menu.top.page-topbar')
    @include('admin.layouts.menu.top.remove-notification-modal')

    <!-- ========== App Menu ========== -->
    @include('admin.layouts.menu.sidebar.main')
    <!-- Left Sidebar End -->
    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <!-- start page title -->
                @include('admin.layouts.start-page')
                <!-- end page title -->
